...
public class AnalogClockApp extends JFrame {
    ...
    private class ClockPanel extends JPanel
    {
        ...
        protected void paintComponent(Graphics g)
        {
            ...
            g2d.setColor(new Color(190,190,190)); // Set the color for the clock face
            ...
            // Draw hour numbers
            g2d.setFont(new Font("Arial", Font.BOLD, 20)); // Set the font for drawing hour numbers
            g2d.setColor(Color.black); // Set the color for the hour numbers
            ...
            drawClockHand(g2d, centerX, centerY, clockRadius * 0.5, hoursAngle, 6, Color.black);
            ...
            drawClockHand(g2d, centerX, centerY, clockRadius * 0.8, secondsAngle, 2, Color.black);
